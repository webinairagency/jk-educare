    ...
    >
      <div className="relative h-10 w-10 shrink-0">
        <Image
          ...
          fill
          sizes="40px"
          className="rounded-xl object-contain transition-opacity duration-300 opacity-100 dark:opacity-0"
          priority
        />
        <Image
          src="/logo-dark.png"
          ...
          fill
          sizes="40px"
          className="rounded-xl object-contain transition-opacity duration-300 opacity-0 dark:opacity-100"
          priority
        />
      </div>
