        ...
        <div className="grid items-center gap-14 lg:grid-cols-2">
          ...
          >
            <motion.div
              ...
              style={{
                background: 'linear-gradient(135deg, #22c55e, #16a34a)',
                boxShadow: '0 24px 64px rgba(33, 172, 84, 0.48)',
              }}
            ...
            >
              ...
              <div className="relative flex items-center gap-4 mb-6">
                ...
                <div>
                  <p className="font-display text-xl font-bold text-black">JK Edu-Care</p>
                  <p className="text-sm text-green-200 text-white">Official WhatsApp Channel</p>
                </div>
                <div className="ml-auto flex items-center gap-2 rounded-full bg-white/20 px-3 py-1">
              ...
              {[
                ...
                <motion.div
                  ...
                  className="mb-3 rounded-2xl bg-white/10 px-4 py-3 text-sm text-black backdrop-blur-sm last:mb-0"
                >
                  {msg}
                </motion.div>
              ))}
